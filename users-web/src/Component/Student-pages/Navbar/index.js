                    ...
                    <Container>
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav" >
                            <Nav className="m-auto">
                               <Link className='student-nav-link nav-link-animation' to="/studentPages/courses">All courses</Link>
                               <Link className='student-nav-link nav-link-animation' to="/studentPages/JoinCorse">Join course</Link>
