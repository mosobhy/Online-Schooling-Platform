...
class Course(models.Model):
    ...
    students = models.ManyToManyField(User, on_delete=models.CASCADE, related_name='enrolled_students')
...
class Matrial(models.Model):
    ...
    course = models.ForeignKey(Course , on_delete=models.CASCADE, related_name='uploaded_materials')
